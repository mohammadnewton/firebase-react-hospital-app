        ...
        <section>
          <div className="md:grid grid-cols-2 h-screen ">
            ...
            <div className="bg-sidebar md:block hidden text-secondary h-screen">
              <div
                className="flex items-center justify-center bg-no-repeat bg-center bg-cover h-screen bg-[url('https://images.unsplash.com/photo-1640876777002-badf6aee5bcc?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y2xpbmljfGVufDB8MXwwfHx8MA%3D%3D')]"></div>
            </div>
          </div>
        </section>
      </main>
